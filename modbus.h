...
#define BUF_SZ 55                       //Количество байт данных фрейма Modbus//
#define MODBUS_ADDR 99                  //Сетевой адрес modbus устройства//
#define OBJ_SZ 15                       //Общее количество регистров//
#define REG_IN1_COUNTER 11              // Регистр счетчика импульсов ВХОД 1
#define REG_IN2_COUNTER 12              // Регистр счетчика импульсов ВХОД 2
...
WORD_VAL res_table[OBJ_SZ];             //Таблица регистров модбас, с которых происходит чтение значений пареметров//
                                        ...
                                        //[11]- Счетчик импульсов 1  REG_IN1_COUNTER//
                                        //[12]- Счетчик импульсов 2  REG_IN2_COUNTER//
                                        //[13]- Резерв//
                                        //[14]- Резерв//
